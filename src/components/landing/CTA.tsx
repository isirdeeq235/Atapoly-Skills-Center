...
const testimonials = [
  {
    quote: "The training completely transformed my career. Within 3 months of completing the program, I landed my dream job.",
    name: "Adaeze Okonkwo",
    role: "Software Developer",
    program: "Full Stack Development",
  },
  {
    quote: "The instructors are incredibly knowledgeable and supportive. The hands-on approach made all the difference.",
    name: "Chinedu Eze",
    role: "Data Analyst",
    program: "Data Science Fundamentals",
  },
  {
    quote: "Best investment I've made in myself. The cohort-based learning helped me stay accountable and motivated.",
    name: "Fatima Ibrahim",
    role: "UX Designer",
